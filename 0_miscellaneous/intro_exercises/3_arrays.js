...
dinnerTray = [...diet] //note to self. Simply using dinnerTray = diet will just create a reference to diet, not a true clone
console.log(dinnerTray)
console.log(dinnerTray === diet)
...
console.log("Expectation: b, d, f, h")
